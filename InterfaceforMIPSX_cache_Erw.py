...
class Interface(Frame):
    ...
    def getfiles_data(self):
        ...
        try:
            self.path_getfiles_data.grid_forget()
        except:
            pass   
        
        try:
            self.bouton_convert_data_dec2hex.grid_forget()
        except:
            pass   
    ...
    def getFiles_hex(self):
        ...
        try:
            self.path_getFiles_Hex.grid_forget()
        except:
            pass   
        
        try:
            self.button_startISS.grid_forget() #self.button_startISS.destroy()
        except:
            pass   
        
        try:
            self.bouton_pasapas.grid_forget() # self.bouton_pasapas.destroy()
        except:
            pass   
    ...
    def loadData(self):
        ...
        try:
            self.path_loadData.grid_forget()
        except:
            pass   
...
#        self.path_file_data_Dec2Hex.grid(row=self.posData + 1, column=3)
    ...
    def startAssembly(self):
        ...
        try:
            self.button_startISS.grid_forget()
        except:
            pass   
        
        try:
            self.bouton_pasapas.grid_forget()
        except:
            pass   
...
#        self.path_startAssembly.grid(row=self.posAssembly + 1, column=3)
        ...
        self.bouton_startAssembly.grid_forget()
    ...
    def clearaffichage(self):
        self.bouton_getfile_data_decimal.grid_forget()

        self.bouton_getfiles_ass.grid_forget()
        self.bouton_getfiles_hex.grid_forget()
        self.bouton_loadData.grid_forget()
        ...
        try :
            ...
            pass
        try:
            self.path_file_data_Dec2Hex.grid_forget()
        except:
            pass
        ...
        try:
            self.path_getfiles_ass.grid_forget()
        except:
            pass
        ...
        try:
            self.path_startAssembly.grid_forget()
        except:
            pass
    ...
    def clearExecution(self):
        ...
        try : 
            self.bouton_startISS.grid_forget()
        except:
            pass
